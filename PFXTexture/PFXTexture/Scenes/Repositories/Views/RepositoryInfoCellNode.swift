...
class RepositoryInfoCellNode: ASCellNode {
    ...
    private let room: RepositoryInfoCellNode.Content
    ...
    init(with room: RepositoryInfoCellNode.Content) {
        self.room = room
    ...
    private func setupImageNode() {
        self.imageNode.url = room.avatarUrl
